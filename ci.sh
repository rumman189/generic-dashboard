...
git config --global user.email "rumman189@gmail.com"
git config --global user.name "rumman189"
...
# 2018.May26
git commit -m  "invoice and user done"
...
git remote set-url origin https://github.com/rumman189/generic-dashboard
############
# Step: 07 #
############
...
git push --all -f https://github.com/rumman189/generic-dashboard
